...
migrateup:
	migrate -path db/migration -database "postgresql://root:z6rX4QHe4sZ49JyFDH47@banking.cg1a7yuqjmvt.ap-southeast-1.rds.amazonaws.com:5432/simple_bank" -verbose up
